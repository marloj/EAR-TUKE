...
namespace Ear {
    ...
    public:
        ...
        inline float &get(const unsigned int _i) {
            return pfData[_i];
        }
        ...
        void clear() {
            if (pfData) memset(pfData, 0, iCap * sizeof (float));
            iSize = 0;
        }
        ...
        /// Computes RMS for the data (root mean square, the sample volume (?) )
    ...
    public:
        ...
        virtual void setSource(ADataProcessor *_pPrev) {
            m_pPrev = _pPrev;
        }
        ...
        virtual ADataProcessor* getSource() {
            return m_pPrev;
        }
    ...
    protected:
        ...
        void actualize(CDataContainer &_pData) {
            if (m_pPrev) m_pPrev->getData(_pData);
            else _pData.reserve(0);
        }
    };
    ...
    public:
        ...
        AAuxDataProcessor() : ADataProcessor() {
            m_pAuxPrev = NULL;
        }
    ...
    public:
        ...
        virtual void getAuxData(CDataContainer& _pData) {
            getData(_pData);
        }
    ...
    protected:
        ...
        void actualizeAux(CDataContainer &_pData) {
            if (m_pAuxPrev) m_pAuxPrev->getAuxData(_pData);
            else _pData.clear();
        }
    };
