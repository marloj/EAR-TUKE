...
namespace Ear {
    ...
    public:
        ...
        inline void addAuxScore(float _fScore) {
            fAuxScore += _fScore;
        }

        inline void addMainScore(float _fScore) {
            fMainScore += fNextMainScore;
            fNextMainScore = _fScore;
        }

        inline float getMainScore() {
            return fMainScore;
        }

        inline float getScore() {
            return fMainScore + fNextMainScore + fAuxScore;
        }
